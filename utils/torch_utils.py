...
from utils.general import check_version, colorstr, file_date, git_describe, LOGGER
...
def reshape_classifier_output(model, n=1000):
    ...
    name, m = list((model.model if hasattr(model, "model") else model).named_children())[
        -1
    ]  # last module
