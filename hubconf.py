...
def _create(
    ...
    from utils.general import check_requirements, intersect_dicts, LOGGER, logging
...
if __name__ == "__main__":
    ...
    # Model
    model = _create(
        name=opt.model, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True
    )
